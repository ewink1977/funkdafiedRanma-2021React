				...
				<div className='display'>
					...
					<div className='content'>
						...
						<Switch>
							...
							<Route
								path='/imagegal/'
								component={FunkdafiedImageGallery}
							/>
							<Route
								exact
								path='/fanfics/'
							...
							<Route
								path='/fanfics/rmsm/'
								component={RanmaMeetsSailorMoon}
							/>
							...
							/>
							<Route
								path='/engagementchart/kim-counterpoint/'
								component={KimCounterpoint}
							/>
							<Route
								exact
								path='/characters/'
							...
							/>
							<Route
								path='/characters/ranma-boy/'
								component={RanmaBoyType}
							/>
							<Route
								path='/characters/ranma-girl/'
								component={RanmaGirlType}
							/>
							<Route
								path='/characters/akane/'
								component={Akane}
							/>
							<Route
								path='/characters/genma/'
								component={Genma}
							/>
							<Route path='/characters/soun/' component={Soun} />
							<Route
								path='/characters/ryouga/'
								component={Ryouga}
							/>
							<Route
								path='/characters/shampoo/'
								component={Shampoo}
							/>
							<Route
								path='/characters/kuno/'
								component={Tatewaki}
							/>
							<Route
								path='/characters/nabiki/'
								component={Nabiki}
							/>
							<Route
								path='/characters/kasumi/'
								component={Kasumi}
							/>
							<Route
								path='/characters/happosai/'
								component={Happosai}
							/>
							<Route
								path='/characters/cologne/'
								component={Cologne}
							/>
							<Route
								path='/characters/kodachi/'
								component={Kodachi}
							/>
							<Route
								path='/characters/ukyou/'
								component={Ukyou}
							/>
							<Route
