...
const characterPages = [
	...
	},
	{
		...
		desc:
			"Ranma Saotome in his so called 'cursed' yet much cuter girl form!",
	...
	},
	{
		...
		name: 'Nabiki Tendo',
		desc:
			"Voted most likely to join the Yakuza, Akane's older sister, Nabiki!",
	...
	},
	{
		...
		name: 'Kasumi Tendo',
		desc:
			"The sweetest character in all of Ranmaland, Akane's oldest sister, Kasumi!",
	...
	},
	{
		...
		name: 'Cologne',
		desc:
			"Master of Ramen and martial arts, Shampoo's great grandmother, Cologne!",
	...
	},
	{
		...
		name: 'Miscellanious',
		desc:
			'Characters that are unworthy of their own page, or I forgot about them.',
		url: '/characters/misc/',
	},
]
	...
	return (
		<div>
			...
			<section>
				...
				<p>
					In order to supply you with the most detailed character
					biography, our staff journalists have sat down with all the
					characters and done an in-depth interview. This way we can
					find out more about what makes them do what it is they do
					when they are doing it.
				</p>
				<p>
					Anyway, you should find most of what you need to know about
					the main characters of Ranma by following the links below!
				</p>
			</section>
			<div className='char-namelist'>
				<div className='char-col-left'>
					{characterPages.map((character) => (
						<p className='char-name' key={character.id}>
				...
				<div className='char-col-right'>
					{characterPages.map((character) => (
						<p class='char-desc' key={character.id}>
							{character.desc}
						</p>
					))}
				</div>
			</div>
			<div className='mob-char-list'>
				{characterPages.map((character) => (
					<p className='mob-char-name' key={character.id}>
						<Link to={character.url}>{character.name}</Link>
					</p>
				))}
			</div>
			<section>
				<p className='tiny-text'>
					*Minako Aino from Sailor Moon has Shampoo beat by a couple
					of years.
				</p>
				<p>
					Feel free to give me a shout on{' '}
					<a
					...
					if you think I need to add more characters!
				</p>
			</section>
		</div>
	)
